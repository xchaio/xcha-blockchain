...
function getInstallerConfig () {
  ...
  return Promise.resolve({
    appDirectory: path.join(rootPath, 'Xcha-win32-x64'),
    authors: 'Xcha Network',
    version: process.env.XCHA_INSTALLER_VERSION,
    noMsi: true,
    ...
    exe: 'Xcha.exe',
    setupExe: 'XchaSetup-' + process.env.XCHA_INSTALLER_VERSION + '.exe',
