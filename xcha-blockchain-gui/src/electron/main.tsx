...
if (!handleSquirrelEvent()) {
  ...
  const getMenuTemplate = () => {
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/xcha_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/xcha_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Xcha Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Xcha' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Xcha Blockchain' }),
            click: () => {
              openAbout();
            },
          },
