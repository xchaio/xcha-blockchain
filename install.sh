...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Xcha Blockchain requires a 64 bit OS and this is 32 bit armv7l"
...
echo ""
echo "Try the Quick Start Guide to running xcha-blockchain:"
echo "https://github.com/Chia-Network/chia-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'xcha init' to begin."
