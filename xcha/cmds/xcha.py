...
from xcha.cmds.configure import configure_cmd
from xcha.cmds.farm import farm_cmd
from xcha.cmds.init import init_cmd
from xcha.cmds.keys import keys_cmd
from xcha.cmds.netspace import netspace_cmd
from xcha.cmds.plots import plots_cmd
from xcha.cmds.show import show_cmd
from xcha.cmds.start import start_cmd
from xcha.cmds.stop import stop_cmd
from xcha.cmds.wallet import wallet_cmd
from xcha.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage xcha blockchain infrastructure ({__version__})\n",
    epilog="Try 'xcha start node', 'xcha netspace -d 192', or 'xcha show -s'",
...
@cli.command("version", short_help="Show xcha version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs xcha daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from xcha.daemon.server import async_run_daemon
    import asyncio
