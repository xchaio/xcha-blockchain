...
def init_cmd(ctx: click.Context, create_certs: str):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.xcha/[version]/config/ssl/ca
    - Shut down all xcha daemon processes with `xcha stop all -d`
    - Run `xcha init -c [directory]` on your remote harvester,
      where [directory] is the the copy of your Farming Machine CA directory
    - Get more details on remote harvester on Xcha wiki:
