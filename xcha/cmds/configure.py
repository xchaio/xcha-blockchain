...
from xcha.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "55120"
            testnet_introducer = "beta1_introducer.xcha.io"
            testnet = "testnet7"
            ...
            mainnet_port = "5120"
            mainnet_introducer = "introducer.xcha.io"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running xcha services for changes to take effect")
