...
from xcha.cmds.init_funcs import check_keys
from xcha.consensus.block_rewards import calculate_base_farmer_reward
from xcha.pools.pool_wallet import PoolWallet
from xcha.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from xcha.protocols.protocol_message_types import ProtocolMessageTypes
from xcha.server.outbound_message import NodeType, make_msg
from xcha.simulator.simulator_protocol import FarmNewBlockProtocol
from xcha.types.blockchain_format.coin import Coin
from xcha.types.blockchain_format.sized_bytes import bytes32
from xcha.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from xcha.util.byte_types import hexstr_to_bytes
from xcha.util.ints import uint32, uint64
from xcha.util.keychain import bytes_to_mnemonic, generate_mnemonic
from xcha.util.path import path_from_root
from xcha.util.ws_message import WsRpcMessage, create_payload_dict
from xcha.wallet.cc_wallet.cc_wallet import CCWallet
from xcha.wallet.derive_keys import master_sk_to_singleton_owner_sk
from xcha.wallet.rl_wallet.rl_wallet import RLWallet
from xcha.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from xcha.wallet.did_wallet.did_wallet import DIDWallet
from xcha.wallet.trade_record import TradeRecord
from xcha.wallet.transaction_record import TransactionRecord
from xcha.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from xcha.wallet.util.trade_utils import trade_record_to_dict
...
from xcha.wallet.wallet_node import WalletNode
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from xcha.pools.pool_wallet_info import initial_pool_state_from_dict
