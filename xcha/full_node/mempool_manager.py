...
from xcha.full_node.bundle_tools import simple_solution_generator
from xcha.full_node.coin_store import CoinStore
from xcha.full_node.mempool import Mempool
from xcha.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
from xcha.types.blockchain_format.coin import Coin
from xcha.types.blockchain_format.program import SerializedProgram
...
from xcha.util.clvm import int_from_bytes
...
from xcha.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XCA per block, or about 0.00005 XCA for two
        # spends.
