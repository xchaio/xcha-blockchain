...
import xcha.server.ws_connection as ws  # lgtm [py/import-and-import-from]
from xcha.consensus.block_creation import unfinished_block_to_full_block
from xcha.consensus.block_record import BlockRecord
from xcha.consensus.blockchain import Blockchain, ReceiveBlockResult
from xcha.consensus.constants import ConsensusConstants
from xcha.consensus.difficulty_adjustment import get_next_sub_slot_iters_and_difficulty
from xcha.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from xcha.consensus.multiprocess_validation import PreValidationResult
from xcha.consensus.pot_iterations import calculate_sp_iters
from xcha.full_node.block_store import BlockStore
from xcha.full_node.bundle_tools import detect_potential_template_generator
from xcha.full_node.coin_store import CoinStore
from xcha.full_node.full_node_store import FullNodeStore
from xcha.full_node.mempool_manager import MempoolManager
from xcha.full_node.signage_point import SignagePoint
from xcha.full_node.sync_store import SyncStore
from xcha.full_node.weight_proof import WeightProofHandler
from xcha.protocols import farmer_protocol, full_node_protocol, timelord_protocol, wallet_protocol
from xcha.protocols.full_node_protocol import (
    RejectBlocks,
    RequestBlocks,
    RespondBlock,
    RespondBlocks,
...
from xcha.protocols.protocol_message_types import ProtocolMessageTypes
from xcha.server.node_discovery import FullNodePeers
from xcha.server.outbound_message import Message, NodeType, make_msg
from xcha.server.server import ChiaServer
from xcha.types.blockchain_format.classgroup import ClassgroupElement
from xcha.types.blockchain_format.pool_target import PoolTarget
from xcha.types.blockchain_format.sized_bytes import bytes32
from xcha.types.blockchain_format.sub_epoch_summary import SubEpochSummary
from xcha.types.blockchain_format.vdf import CompressibleVDFField, VDFInfo, VDFProof
from xcha.types.end_of_slot_bundle import EndOfSubSlotBundle
...
from xcha.types.spend_bundle import SpendBundle
from xcha.types.unfinished_block import UnfinishedBlock
from xcha.util.bech32m import encode_puzzle_hash
from xcha.util.db_wrapper import DBWrapper
from xcha.util.errors import ConsensusError, Err
from xcha.util.ints import uint8, uint32, uint64, uint128
from xcha.util.path import mkdir, path_from_root
from xcha.util.safe_cancel_task import cancel_task_safe
from xcha.util.profiler import profile_task
...
class FullNode:
    ...
    def set_server(self, server: ChiaServer):
        ...
        elif self.config["port"] == 5120:
            # If `dns_servers` misses from the `config`, hardcode it if we're running mainnet.
            dns_servers.append("dns-introducer.xcha.io")
        try:
