...
# the output will be printed to your xcha root path, e.g. ~/.xcha/mainnet/profile/
# to analyze the profile, run:

#   python xcha/utils/profiler.py ~/.xcha/mainnet/profile | less -r

# this will print CPU usage of the xcha full node main thread at 1 second increments.
# find a time window of interest and analyze the profile file (which are in pstats format).

# for example:

#   python xcha/utils/profiler.py ~/.xcha/mainnet/profile 10 20
