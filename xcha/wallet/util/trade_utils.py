...
from xcha.types.blockchain_format.program import Program, INFINITE_COST
from xcha.types.condition_opcodes import ConditionOpcode
from xcha.types.spend_bundle import SpendBundle
from xcha.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "xcha" in cc_discrepancies:
                    cc_discrepancies["xcha"] = cc_discrepancies["xcha"] + diff
                else:
                    cc_discrepancies["xcha"] = diff
