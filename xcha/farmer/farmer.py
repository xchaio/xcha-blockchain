...
from xcha.pools.pool_config import PoolWalletConfig, load_pool_config
...
from xcha.util.bech32m import decode_puzzle_hash
from xcha.util.byte_types import hexstr_to_bytes
from xcha.util.config import load_config, save_config, config_path_for_filename
from xcha.util.hash import std_hash
from xcha.util.ints import uint8, uint16, uint32, uint64
from xcha.util.keychain import Keychain
from xcha.wallet.derive_keys import (
...
from xcha.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    def __init__(
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'xcha keys generate' or open the UI."
